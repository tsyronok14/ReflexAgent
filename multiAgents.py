...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        newGhostPositions = [state.configuration.pos for state in newGhostStates if state.scaredTimer != 0]
        ...
        return successorGameState.getScore() + closestGhost + 20/ (closestFood) + score
